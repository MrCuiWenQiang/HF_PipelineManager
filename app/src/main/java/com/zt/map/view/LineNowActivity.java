...
public class LineNowActivity extends BaseMVPAcivity<LineContract.View, LinePresenter> implements LineContract.View, View.OnClickListener {
    ...
    private ImageView iv_load_sfcs;
    private TextView tv_gxzt;
    private ImageView iv_load_gxzt;
    private TextView tvQsdw;
    private ImageView iv_load_qsdw;
    ...
    private String[] cs = new String[]{"0", "1"};
    private String[] gx = new String[]{"新增", "修改","删除"};
    private String[] fc = new String[]{"市政道路", "小区","企事业单位",
            "广场", "河道","村庄","其它"};
    ...
    protected void initContentView() {
        ...
        tv_sfcs = findViewById(R.id.tv_sfcs);
        iv_load_sfcs = findViewById(R.id.iv_load_sfcs);
        ...
        tv_gxzt = findViewById(R.id.tv_gxzt);
        iv_load_gxzt = findViewById(R.id.iv_load_gxzt);
        iv_load_qsdw = findViewById(R.id.iv_load_qsdw);
...
//            mPresenter.queryUncertainData(typeId);
    ...
    protected void initListener() {
        ...
        iv_load_sfcs.setOnClickListener(this);
        ivLoadGxcl.setOnClickListener(this);
        ivLoadXx.setOnClickListener(this);
        iv_load_gxzt.setOnClickListener(this);
        iv_load_qsdw.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_load_sfcs: {
                selectValue(tv_sfcs,cs);
                break;
            }      case R.id.iv_load_gxzt: {
                selectValue(tv_gxzt,gx);
                break;
            }
            ...
            case R.id.iv_load_szwz: {//套管材质
                mPresenter.querySzwz(typeId);
                break;
            }
            case R.id.iv_load_qsdw: {//套管材质
                mPresenter.queryQsdw(typeId);
                break;
            }
        }
    }
    ...
    private void save() {
        ...
        tab_line.setSfcs(getValue(tv_sfcs));
        ...
        tab_line.setGxzt(getValue(tv_gxzt));
//        tab_line.setTs(getValue(tvTs));
    ...
    public void queryLine_Success(Tab_Line tabLine) {
        ...
        tv_sfcs.setText(tabLine.getSfcs());

        tvRemarks.setText(tabLine.getRemarks());

        tvXx.setText(tabLine.getXx());
        tv_gxzt.setText(tabLine.getGxzt());
...
//        tvZzms.setText(tabLine.getZzms());
    ...
    @Override
    public void querSzwz(String[] items) {
    ...
    @Override
    public void querQsdw(String[] szwz) {
        selectValue(tvQsdw,szwz);
    }
