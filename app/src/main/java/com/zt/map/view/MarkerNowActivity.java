...
public class MarkerNowActivity extends BaseMVPAcivity<MarkerContract.View, MarkerPresenter> implements MarkerContract.View, View.OnClickListener {
    ...
    private ImageView iv_load_gdfc;
    ...
    protected void initContentView() {
        ...
        iv_load_gdfc = findViewById(R.id.iv_load_gdfc);
...
//        tvWtdh.setTransformationMethod(new AutoCaseTransformationMethod());
    ...
    protected void initListener() {
        ...
        iv_load_gdfc.setOnClickListener(this);
    ...
    private void save() {
        ...
        tab.setSfcs(getValue(tv_sfcs));

        tab.setGxlx(getValue(tvGxlx));
        tab.setHqsj(getValue(tv_hqsj));
        tab.setGxzt(getValue(tv_gxzt));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_load_gdfc: {
                selectValue(tv_gdfc,fc);
                break;
            }
...
//        setResult();
    ...
    public void queryMarker_success(Tab_Marker marker) {
        ...
        tv_gxzt.setText(marker.getGxzt());
        ...
        tv_sfcs.setText(marker.getSfcs());
